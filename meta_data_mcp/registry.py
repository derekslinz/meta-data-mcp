...
_STATIC_ENTRIES: tuple[ProviderEntry, ...] = (
    ...
    ProviderEntry(
        id="ch_opendata_swiss",
        server_name="ch-opendata-swiss",
        title="opendata.swiss",
        description="Swiss federal open-data catalog (CKAN) for dataset search, organizations, and tags.",
        domains=("government", "statistics"),
        regions=("ch",),
        keywords=("switzerland", "opendata swiss", "ckan", "open data", "datasets"),
    ...
    ProviderEntry(
        id="de_govdata",
        server_name="de-govdata",
        title="GovData Germany",
    ...
    ProviderEntry(
        id="eu_euvd",
        server_name="eu-euvd",
        title="ENISA EU Vulnerability Database (EUVD)",
        description="Latest, exploited, critical, and filtered vulnerability search from ENISA's EU vulnerability database.",
        domains=("security",),
        regions=("eu", "global"),
        keywords=(
            "euvd",
    ...
    ProviderEntry(
        id="global_circl_cve",
        server_name="global-circl-cve",
        title="CIRCL CVE Search",
        description="Public CVE search, vendor/product browsing, and CVE detail lookups from CIRCL.",
        domains=("security",),
        regions=("global",),
        keywords=(
            "circl",
    ...
    ProviderEntry(
        id="global_crtsh",
        server_name="global-crtsh",
        title="crt.sh Certificate Transparency",
        description="Certificate transparency search for domains and certificate names via crt.sh.",
    ...
    ProviderEntry(
        id="global_hackernews",
        server_name="global-hackernews",
        title="Hacker News API",
        description="Public Firebase API for Hacker News stories, comments, jobs, and user profiles.",
        domains=("news", "knowledge"),
        regions=("global",),
        keywords=("hacker news", "hn", "tech news", "stories", "comments", "startups"),
    ...
    ProviderEntry(
        id="global_pwned_passwords",
        server_name="global-pwned-passwords",
        title="Pwned Passwords",
        description="Anonymous k-anonymity range lookups for breached password SHA-1 hash prefixes.",
        domains=("security",),
        regions=("global",),
        keywords=(
            "pwned passwords",
    ...
    ProviderEntry(
        id="global_rest_countries",
        server_name="global-rest-countries",
        title="REST Countries",
        description="Country reference data — borders, capitals, currencies, languages, populations, timezones, and regions for 250+ countries.",
        domains=("geo", "demographics", "government", "knowledge"),
        regions=("global",),
        keywords=(
            "countries",
            "iso",
    ...
    ProviderEntry(
        id="global_solarsystem",
        server_name="global-solarsystem",
        title="Le Systeme Solaire API",
    ...
    ProviderEntry(
        id="global_ssllabs",
        server_name="global-ssllabs",
        title="SSL Labs",
        description="Public TLS configuration analysis and endpoint details from Qualys SSL Labs.",
        domains=("security", "networking"),
        regions=("global",),
        keywords=(
            "ssl labs",
    ...
    ProviderEntry(
        id="global_transitous",
        server_name="global-transitous",
        title="Transitous (Transit Routing)",
        description="Door-to-door public transit journey planning worldwide — travel times, transfers, per-leg itineraries, stop departures — via the community-run MOTIS router over open GTFS feeds.",
        domains=("transit",),
        regions=("global",),
        keywords=(
            "transitous",
        ...
        license_note="Transitous is a community-run service routing over open GTFS feeds; cite 'Transitous' and the underlying transit agencies. No API key — identify your client via User-Agent and keep request rates modest.",
    ),
    ProviderEntry(
    ...
    ProviderEntry(
        id="nl_ovapi",
        server_name="nl-ovapi",
        title="OVapi (Dutch Transit, Live)",
        description="Live Dutch public transport — line search, stop networks, real-time departures with delays, vehicle positions, and GTFS/GTFS-RT feed listings.",
        domains=("transit",),
        regions=("nl",),
        keywords=(
            "ovapi",
        ...
        homepage="https://gtfs.ovapi.nl/",
        license_note="OVapi is a community-run service redistributing Dutch NDOV open transit data; identify your client via User-Agent and keep request rates modest.",
    ),
    ProviderEntry(
        id="nl_rechtspraak",
